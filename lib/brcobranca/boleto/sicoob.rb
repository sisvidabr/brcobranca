...
module Brcobranca
  module Boleto
    class Sicoob < Base # Sicoob (Bancoob)
      ...
      validates_length_of :convenio, :maximum => 7, :message => 'deve ser menor ou igual a 7 dígitos.', :allow_nil => true
      validates_length_of :variacao, :maximum => 2, :message => 'deve ser menor ou igual a 2 dígitos.', :allow_nil => true
      validates_length_of :quantidade, :maximum => 3, :message => 'deve ser menor ou igual a 3 dígitos.', :allow_nil => true

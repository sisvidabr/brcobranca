...
module Brcobranca
  module Boleto
    class Sicredi < Base # Banco SICREDI
      ...
      validates_length_of :numero_documento, :maximum => 5, :message => 'deve ser menor ou igual a 5 dígitos.', :allow_nil => true
      ...
      validates_length_of :posto, :maximum => 2, :message => 'deve ser menor ou igual a 2 dígitos.', :allow_nil => true

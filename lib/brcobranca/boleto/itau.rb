...
module Brcobranca
  module Boleto
    class Itau < Base # Banco Itaú
      ...
      validates_length_of :convenio, :maximum => 5, :message => 'deve ser menor ou igual a 5 dígitos.', :allow_nil => true
      validates_length_of :numero_documento, :maximum => 8, :message => 'deve ser menor ou igual a 8 dígitos.', :allow_nil => true
      validates_length_of :conta_corrente, :maximum => 5, :message => 'deve ser menor ou igual a 5 dígitos.', :allow_nil => true
      validates_length_of :seu_numero, :maximum => 7, :message => 'deve ser menor ou igual a 7 dígitos.', :allow_nil => true
